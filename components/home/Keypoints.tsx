        ...
        <div className="my-container">
            <div className="flex flex-wrap justify-center gap-12 my-20 md:gap-0 lg:justify-evenly">
                <div className="max-w-sm p-2 text-center">
                    <MdAddHomeWork className="mx-auto mb-6 text-5xl md:text-6xl text-primary" />
                    <h1 className="mb-2 text-2xl font-bold md:text-2xl">Expertise and Experience</h1>
                ...
                <div className="max-w-sm p-2 text-center">
                    <BsPeopleFill className="mx-auto mb-6 text-5xl md:text-6xl text-primary" />
                    <h1 className="mb-2 text-2xl font-bold md:text-2xl">Portfolio and References</h1>
                    <p className="text-[1.35rem] opacity-60 md:text-lg">
                ...
                <div className="max-w-sm p-2 text-center">
                    <BiTimeFive className="mx-auto mb-6 text-5xl md:text-6xl text-primary" />
                    <h1 className="mb-2 text-2xl font-bold md:text-2xl">Commitment to Timelines</h1>
                    <p className="text-[1.35rem] opacity-60 md:text-lg">
