  ...
  return (
    <div className="mt-20 h-[70vh] relative">
      <div className="absolute h-full w-full -z-10">
        <Image src={heroBackground} className="object-cover h-full w-full" alt="Colorful Kitchen" placeholder="blur" priority />
      </div>
      <div className="bg-black bg-opacity-25 h-full">
        <div className="container-custom h-full flex items-center text-white">
          <div className="bg-black bg-opacity-50 px-8 lg:px-16 py-14 lg:py-20 relative rounded-md">
            ...
            <div className="max-w-[53rem] pb-10 pt-5 font-light text-lg md:text-xl lg:text-xl">
              Our skilled artisans pour their heart and soul into every project, 
              ensuring impeccable finishes and long-lasting beauty.
            </div>
            <Link
              href="/gallery"
              className="bg-primary border-[3px] border-solid border-transparent inline-block rounded-md text-lg px-7 py-2 md:px-10 md:py-3 md:text-2xl
